...
angular.module('ToDoApp', [])
    .config(function($httpProvider) {
        ...
        $httpProvider.defaults.headers.common['X-Parse-Application-Id'] = 'IpVfpErP17lv1I8z7sRhc7s9zLfg3gCVZyOU1bXm';
        $httpProvider.defaults.headers.common['X-Parse-REST-API-Key'] = 'nXKgWJLwzMVFaEXkyhNDTuGdPi3lVClrEpf6ruds';
    })

    .controller('TasksController', function($scope, $http) {
        $scope.refreshTasks = function() {
          $http.get(tasksUrl + '?where={"done":false}') // get full list of tasks from parse
